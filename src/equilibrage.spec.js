...
describe('équilibrage', () => {
    ...
    describe('trouverEquilibre()', () => {
        ...
        describe('Si une semaine possède chacun 6 points relais', () => {
            it('doit faire passer 3 fois plus de casiers à la semaine suivante ', () => {
                ...
                const premierCasier = {
                    date: 20220404,
                    lockers: 120,
                    places: {a: 70, b: 10, c: 10, d: 10, e: 10, f: 10}
                };

                const deuxièmeCasier = {
                    date: 20220411,
                    lockers: 60,
                    places: {a: 10, b: 10, c: 10, d: 10, e: 10, f: 10}
                };
        ...
        xdescribe('quand on envoie 4 casiers non équilibré en entrée ', () => {
            it('doit retourner 4 casiers équilibrés ', () => {
                // Given
                const casierNonEquilibrés = [{
                    date: 20220404,
                    lockers: 45,
